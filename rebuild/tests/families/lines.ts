...
export const LINE_FAMILIES: readonly RuleFamily[] = [
  ...
  },
  {
    ...
    rules: {
      ...
      gecko: ['gecko/lines/in-word-advance-unit-minus-suffix', 'gecko/icu4x/break-all-letters-as-id', 'gecko/lines/word-wrap-break-priority', 'gecko/style/break-word-is-overflow-wrap-anywhere', 'gecko/gap/in-word-prefix', 'gecko/spacing/letter-spacing-after-cluster'],
    },
    why: 'A break inside a word reshapes the line edges at unsafe offsets in Blink (blink-lines §6), carries the rest of a split item without measuring it again in WebKit (webkit-lines H4: AV×17 in 16px Arial starts lines at [0, 11, 22]), and takes in-word advances from one shaping of the unit in Gecko. Relevant: kerning pairs and ligatures inside the word, and which property breaks it.',
    relevant: [
