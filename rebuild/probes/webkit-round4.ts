...
export default async function round4Probes(): Promise<Probe[]> {
  return [
    ...
    probe('webkit-round4 R13 (system fallback by language outside Han, kana and Hangul)', 'webkit-canvas §1.3 locale; round 4 R13', { LANGS: ['', 'en', 'ar', 'fa', 'ur', 'ps', 'sd', 'ks', 'ku', 'ug', 'he', 'yi', 'hi', 'mr', 'ne', 'sa', 'bn', 'as', 'pa', 'gu', 'ta', 'te', 'kn', 'ml', 'si', 'th', 'lo', 'my', 'km', 'bo', 'ka', 'hy', 'am', 'ru', 'uk', 'bg', 'sr', 'el', 'vi', 'tr', 'de', 'ja', 'ko', 'zh-Hans', 'zh-Hant'], FONTS: ['16px Georgia', '16px Helvetica', '16px Menlo'], TEXTS: ['سلام', 'ہے', 'ێ', 'שלום', 'नमस्ते', 'বাংলা', 'ਪੰਜਾਬੀ', 'ગુજરાતી', 'தமிழ்', 'తెలుగు', 'ಕನ್ನಡ', 'മലയാളം', 'සිංහල', 'สวัสดี', 'ລາວ', 'မြန်မာ', 'ខ្មែរ', 'བོད', 'ქართული', 'Հայերեն', 'አማርኛ', 'Привет', 'Ελληνικά', '→≤✓│', '①㈱', '€₹₽', '𝒜', '🙂'] }, R12),
