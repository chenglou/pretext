...
test('priority and group cuts preserve script-only measurement ranges and the numeric direction exception', () => {
  ...
  const shape = new ShapingSegments(text, scripts, priorities, [
    { start: 0, end: 2, style: 0, rtl: false, cuts: [], prefixAtCut: [], startTrim16: 0, endTrim16: 0, prefix16: new Float64Array(0), pair16: new Float64Array(0), wide16: new Float64Array(0), words: false },
    { start: 2, end: text.length, style: 0, rtl: false, cuts: [], prefixAtCut: [], startTrim16: 0, endTrim16: 0, prefix16: new Float64Array(0), pair16: new Float64Array(0), wide16: new Float64Array(0), words: false },
  ], groupOfUnit)
  ...
  for (const fixture of fixtures) for (const rtl of [false, true]) {
    ...
    for (const clipped of [false, true]) {
      ...
      const groups = starts.map((start, k) => ({ start, end: starts[k + 1] ?? text.length, rtl, style: 0, cuts: [],
        prefixAtCut: [], startTrim16: 0, endTrim16: 0, prefix16: new Float64Array(0), pair16: new Float64Array(0), wide16: new Float64Array(0), words: false }))
