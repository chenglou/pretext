...
import { FULL_WIDTH, NO_BOX_EDGE, UNKNOWN_FONT_FACTS, type FontDecl, type Gap, type GeckoTextFrame, type InlineNode, type LineSlot, type Paragraph } from '../../model.js'
