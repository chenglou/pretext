...
import type { Fragment, Gap, GapName, GeckoCharacter, GeckoFrameGeometry, LineSlot, TextAlign } from '../../model.js'
...
import { KIND_NEWLINE, KIND_TAB, type GeckoElement, type GeckoLine, type GeckoLineResult, type GeckoLineStart, type GeckoPrepared, type GeckoTextRun } from './types.js'
