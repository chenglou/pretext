...
| `ko-sonagi` | Korean | exact | not recently rerun | n/a | `61/61 exact` | Korean coarse corpus is clean |
...
| `ko-sonagi` | clean on sampled matrix | `Apple SD Gothic Neo`, `AppleMyungjo` |
